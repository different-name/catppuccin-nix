                ...
                // {
                  ...
                  userstyles =
                    ...
                    // {
                      ...
                      # For any Stylus settings we don't provide options for, or for defining extra userstyles manually
                      extraConfig = mkOption {
                        type = types.attrs;
                        default = { };
                        description = ''
                          Extra JSON formatted options for Stylus
                        '';
                      };
                    };
                };
            ...
            settings.${stylusExtensionId} = mkIf profile.userstyles.enable {
              ...
              settings =
                let
                  ...
                  userstylesSettings = lib.importJSON "${
                    sources.userstyles.override { inherit userstylesConfig; }
                  }/share/storage.js";
                in
                recursiveUpdate userstylesSettings profile.userstyles.extraConfig;
            };
          };
        }) cfg.profiles;
      };
